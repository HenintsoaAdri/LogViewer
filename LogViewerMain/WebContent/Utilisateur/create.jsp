                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted">Créer un nouvel utilisateur</p>
                            <form class="form-horizontal form-material" action="${pageContext.request.contextPath}/Utilisateur/save" method="post">
                            	<div class="row">
	                            	...
	                            	<div class="col-md-6">
		                                ...
		                                <div class="form-group">
		                                    <label class="col-sm-12">Groupe</label>
		                                    <div class="col-sm-12">
		                                        <select id="groupeSelect" name="item.profil.groupe.id" class="form-control form-control-line">
		                                        <% if(liste != null){ 
		                                        for(BaseModel m : liste){  
		                                        	Groupe i = (Groupe)m;
		                                        %>
		                                            <option value="<% out.print(i.getId()); %>" <% if(item.getProfil() != null && item.getProfil().getGroupe().equals(i))out.print("selected"); %>><% out.print(i.getNom()); %></option>
		                                        <% }
		                                        }%>
		                                        </select>
		                                    </div>
