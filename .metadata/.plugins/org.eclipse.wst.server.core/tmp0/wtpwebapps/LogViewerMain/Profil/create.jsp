                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted">Créer un nouveau profil d'utilisateurs</p>
                                            ...
                                            <div class="form-group">
				                               ...
				                               <div class="radio-list col-md-9">
			                                       ...
			                                       <div class="radio radio-primary">
			                                           <input type="radio" name="item.groupe.id" id="groupe<% out.print(i.getId()); %>" value="<% out.print(i.getId()); %>" <% if(i.equals(item.getGroupe()) || user.getProfil().getGroupe().equals(i)) out.print("checked"); %>>
