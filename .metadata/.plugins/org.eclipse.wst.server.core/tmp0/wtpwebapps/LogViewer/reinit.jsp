...
<body>
  <div class="login-page">
		  ...
		  <% } %>
	  <div class="form">
	    <form class="login-form" method="post" action="${pageContext.request.contextPath}/ReinitPassword">
	      <input type="text" placeholder="Adresse email" id="username" name="email" required value="<% out.print(email); %>"/>
