 ...
 * Generated at: 2017-09-01 11:27:34 UTC
...
import adri.logviewermain.filemanager.Log;
...
public final class File_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/Fichiers/../includes/header.jsp", Long.valueOf(1504171669627L));
  ...
  static {
    ...
    _jspx_imports_classes.add("adri.logviewermain.filemanager.Fichier");
    _jspx_imports_classes.add("adri.logviewermain.filemanager.Log");
...
return;
 ...
 if(user.isGenerallyAllowed("Agent")){ 
	...
	Fichier file = (Fichier)request.getAttribute("fichier");
      ...
      out.write("\t\t\t\t\t\t\t<a class=\"pull-right btn btn-success\" href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
