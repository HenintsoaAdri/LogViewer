 ...
 * Generated at: 2017-11-18 21:24:49 UTC
...
import adri.logviewer.model.GroupeView;
...
public final class details_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("adri.logviewer.model.GroupeView");
...
query = query.isEmpty()? query : query + "&";
 ...
 Utilisateur item = (Utilisateur)request.getAttribute("item"); 
	BaseModelPagination pagination = (BaseModelPagination)request.getAttribute("pagination");
      ...
      out.write("                            <li><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/Utilisateur\">Utilisateur</a></li>\r\n");
 ...
 try{
      ...
      out.write("                    \t\t<h3 class=\"box-title\"> Utilisateurs</h3>\r\n");
      out.write("\t                        <div class=\"form-horizontal\">\r\n");
      out.write("\t                            <div class=\"form-body\">\r\n");
      out.write("\t                            \t<a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/Utilisateur/edit/");
 out.print(item.getId()); 
      out.write("\" class=\"btn btn-info pull-right m-l-20 waves-effect waves-light reinit\"> <i class=\"fa fa-pencil\"></i> Modifier ");
 if(item.isReinitPassword()){ 
      out.write(" <strong class=\"animated flash infinite text-danger\">*</strong>");
 } 
      out.write("</a>\r\n");
      out.write("\t                                <p class=\"text-muted\">D&eacute;tails de l'utilisateur</p>\r\n");
 ...
 out.print(item.getEmail()); 
      ...
      out.write("\t                                    <div class=\"col-md-6\">\r\n");
      out.write("\t                                        <div class=\"col-md-12 form-group\">\r\n");
      out.write("\t                                            <label class=\"control-label col-md-3\">Prénom : </label>\r\n");
      out.write("\t                                            <div class=\"col-md-9\">\r\n");
      out.write("\t                                                <p class=\"form-control-static\"> ");
 out.print(item.getPrenom()); 
      ...
      out.write("\t                                            <div class=\"col-md-9\">\r\n");
      out.write("\t                                                <p class=\"form-control-static\"> ");
 out.print(item.getSexeString()); 
      out.write(" <i class=\"fa fw ");
 out.print(item.getSexeIcon()); 
      out.write("\"></i></p>\r\n");
      out.write("\t                                            </div>\r\n");
      out.write("\t                                        </div>\r\n");
      out.write("\t                                        <div class=\"form-group\">\r\n");
      out.write("\t                                            <label class=\"control-label col-md-3\">Activité :</label>\r\n");
      out.write("\t                                            <div class=\"col-md-9\">\r\n");
      out.write("\t                                                <p class=\"form-control-static\"> ");
 out.print(item.getLastLoggedString("Connecté il y a ")); 
      out.write("</p>\r\n");
      out.write("\t                                            </div>\r\n");
      out.write("\t                                        </div>\r\n");
      out.write("\t                                    </div>\r\n");
 ...
 if(item.isReinitPassword()){ 
      out.write("\r\n");
      out.write("\t                                    <div class=\"alert alert-warningalert-dismissable\">\r\n");
      out.write(" \t\t\t\t\t\t\t\t\t\t\t <a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t  \t<p class=\"text-danger\">Demande de réinitialisation de mot de passe</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t");
 } 
      out.write("\r\n");
 ...
 if(item.getProfil() != null){ 
      ...
      out.write("                    <div class=\"col-md-12\">\r\n");
      out.write("                    \t<div class=\"white-box\">\r\n");
      out.write("                    \t\t<h3 class=\"box-title\"> Groupes gérés</h3>\r\n");
      out.write("\t                        <div class=\"form-horizontal\">\r\n");
      out.write("\t                            <div class=\"form-body\">\r\n");
      out.write("\t                                <p class=\"text-muted\">Liste des groupes gérés par l'utilisateur</p>\r\n");
 ...
 if(pagination == null || pagination.getListe() == null || pagination.getListe().isEmpty() ){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    \t<p class=\"text-danger\">Cet utilisateur ne gère aucun groupe</p>\r\n");
      out.write("\t                                    ");
 }else{ 
      out.write("\r\n");
      out.write("\t\t\t\t                            <ul class=\"list-icons list-group\">\r\n");
      out.write("\t\t\t\t                            ");
	for(BaseModel g : pagination.getListe()){ 
				                            	GroupeView i = (GroupeView)g;
				                            
      out.write("\r\n");
      out.write("\t\t\t\t                              <li class=\"p-0\"><a class=\"font-normal\" href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/Groupe/");
 out.print(i.getId()); 
      out.write("\"><i class=\"fa fa-chevron-right text-success\"></i>\r\n");
      out.write("\t\t\t\t                              \t\t");
 out.print(i.getNom()); 
      out.write("\r\n");
      out.write("\t\t\t\t                              \t  </a>\r\n");
      out.write("\t\t\t\t                              \t  <p class=\"text-muted m-l-40\">");
 out.print(i.getDescription()); 
      out.write("</p>\r\n");
      out.write("\t\t\t\t                              \t  <p><span class=\"badge badge-danger m-l-40\">");
 out.print(i.getNombreAgent()); 
      out.write("</span> Agent(s)</p>\r\n");
      out.write("\t\t\t\t                              </li>\r\n");
      out.write("\t\t\t\t                            ");
 } 
      out.write("\r\n");
      ...
      out.write("                    <div class=\"col-md-12\">\r\n");
      out.write("                    \t<div class=\"white-box\">\r\n");
      out.write("                    \t\t<p class=\"label label-danger label-rouded pull-right \"><i class=\"fa fa-shield fw\"></i> Profil #");
 out.print(item.getProfil().getId()); 
      out.write("</p>\r\n");
      out.write("                    \t\t<h3 class=\"box-title\"> <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/Profil/");
 out.print(item.getProfil().getId()); 
      out.write("\">Profil #");
 out.print(item.getProfil().getId()); 
      ...
      out.write("\t                        <div class=\"form-horizontal\">\r\n");
      out.write("\t                            <div class=\"form-body\">\r\n");
      out.write("\t                                <p class=\"text-muted\">D&eacute;tails du profil de groupe</p>\r\n");
      out.write("\t                                <hr class=\"m-t-0 m-b-40\">\r\n");
      out.write("\t                                <div class=\"row\">\r\n");
      out.write("\t                                    <div class=\"col-md-6\">\r\n");
      out.write("\t                                        <div class=\"col-md-12 form-group\">\r\n");
      ...
      out.write("\t                                            <div class=\"col-md-9\">\r\n");
      out.write("\t                                                <p class=\"form-control-static\"> ");
 out.print(item.getProfil().getNom()); 
      out.write(" </p>\r\n");
      out.write("\t                                            </div>\r\n");
      out.write("\t                                        </div>\r\n");
      out.write("\t\t                                    <div class=\"col-md-12 form-group\">\r\n");
      out.write("\t\t                                        <p class=\"col-md-9 col-md-offset-3\">\r\n");
      out.write("\t\t                                        \t");
 out.print(item.getProfil().getDescription());
      ...
      out.write("\t                                    <div class=\"col-md-6\">\r\n");
      out.write("\t                                        <div class=\"form-group\">\r\n");
      out.write("\t                                            <label class=\"control-label col-md-3\">Permission :</label>\r\n");
      out.write("\t                                            <div class=\"col-md-9\">\r\n");
      out.write("                                                \t");
 for(PermissionType p : PermissionType.values()) {
      out.write("\r\n");
      out.write("                                                    <div class=\"checkbox checkbox-success checkbox-circle\">\r\n");
      out.write("\t\t\t\t                                         <input id=\"permission");
 out.print(p.ordinal()); 
      out.write("\" type=\"checkbox\" name=\"item.listePermission\" value=\"");
 out.print(p.name()); 
      out.write('"');
      out.write(' ');
 if(item.getProfil().isAllowed(p)) out.print("checked"); 
      out.write(" disabled>\r\n");
      out.write("\t\t\t\t                                         <label for=\"permission");
 out.print(p.ordinal()); 
      out.write('"');
      out.write('>');
      out.write(' ');
 out.print(p.getLibelle()); 
      ...
      out.write("                    <div class=\"col-md-12\">\r\n");
      out.write("                    \t<div class=\"white-box\">\r\n");
      out.write("\t\t\t\t\t\t\t<p class=\"text-danger\">Cet utilisateur n'est associé à aucun profil</p>\r\n");
      out.write("\t                \t</div>   \r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <!--./row-->\r\n");
      ...
      out.write("                        <a data-toggle=\"modal\" href=\"#delete\" data-item=\"Utilisateur\" data-id=\"");
 out.print(item.getId()); 
      out.write("\" class=\"text-danger pull-right confirmDelete\">Supprimer l'utilisateur</a>\r\n");
      out.write("                    </div>\r\n");
      out.write("                </div>\r\n");
      out.write("                <!-- /.row -->\r\n");
      out.write("\t\t\t    <!-- Modal -->\r\n");
 ...
 if(item.isReinitPassword()){ 
      ...
      out.write("<script>\r\n");
      out.write("$(document).ready(function(){\r\n");
      out.write("    $('.reinit').popover({title: \"Mot de passe oublié\", content: \"<p>Demande de réinitialisation</p>\", html: true, trigger: \"hover\", placement:\"left\"}); \r\n");
      out.write("});\r\n");
      out.write("</script>\r\n");
 } 
      out.write("\r\n");
