 ...
 * Generated at: 2017-09-18 13:38:06 UTC
...
List<LogFile> listeLog = (List<LogFile>)request.getAttribute("listeLog");
 ...
 out.print(item.getNomCreateur()); 
      ...
      out.write("                            <p class=\"text-muted\">Liste des fichiers de log retrouvés</p>\r\n");
      out.write("\t                        <hr class=\"m-t-0 m-b-10\">\r\n");
      out.write("                            ");
 if(listeLog == null || listeLog.isEmpty() ){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t    \t<p class=\"text-danger\">Aucun fichier n'a été retourné par cet agent</p>\r\n");
      out.write("\t\t\t\t\t\t\t");
 }else{ 
      out.write("\r\n");
	...
	for(LogFile i : listeLog){  
      out.write("\r\n");
      out.write("\t                              <li class=\"text-center p-20\"><a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/Agent/");
 out.print(item.getId()); 
      out.write("/open?log.fileName=");
 out.print(i.getFileName()); 
      out.write("\"><i class=\"fa fa-file text-success\"></i>\r\n");
      out.write("\t\t\t\t                      <p>");
 out.print(i.getFileName()); 
      out.write(' ');
      out.write('(');
 out.print(i.getDistantFile().length()/(1024*1024)); 
      out.write(" Mo)</p>\r\n");
      out.write("\t                              \t  </a>\r\n");
      out.write("\t                              </li>\r\n");
      out.write("\t                            ");
  ...
  private boolean _jspx_meth_s_005ffielderror_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /Agent/connexion.jsp(35,16) name = cssClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
