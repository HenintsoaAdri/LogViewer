 ...
 * Generated at: 2017-07-19 12:03:40 UTC
...
public final class select_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/Utilisateur/../includes/header.jsp", Long.valueOf(1500462491905L));
    _jspx_dependants.put("/Utilisateur/../includes/footer.jsp", Long.valueOf(1499669929513L));
  }
...
return;
 ...
 List<? extends BaseModel> liste = (List<? extends BaseModel>)request.getAttribute("liste"); 
      ...
      out.write("\t\t\t\t           <h3 class=\"box-title\">Utilisateur</h3>\r\n");
      out.write("\t\t\t\t           <p class=\"text-muted\">Veuillez sélectionner le groupe dans lequel l'utilisateur sera placé</p>\r\n");
      out.write("\t\t\t\t\t\t\t<form class=\"form-horizontal form-material\" action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/Utilisateur/new\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t        \t<div class=\"row\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\t\t\t\t\t           \r\n");
 ...
 for(BaseModel g : liste){ 
      ...
      out.write("\t\t                                           <input type=\"radio\" name=\"item.profil.groupe.id\" id=\"groupe");
 out.print(i.getId()); 
      out.write("\" value=\"");
 out.print(i.getId()); 
      out.write('"');
      out.write(' ');
 if(i.getId() == user.getProfil().getGroupe().getId()) out.print("checked"); 
      out.write(">\r\n");
 ...
 out.print(i.getNom()); 
      ...
      out.write("\t\t                                       <button class=\"btn btn-primary\" type=\"submit\">Cr&eacute;er l'utilisateur</button>\r\n");
      out.write("\t\t                                   </div>\r\n");
      out.write("\t\t                               </div>\r\n");
      out.write("\t\t\t                        </div>  \r\n");
      out.write("\t\t                \t\t</div>\r\n");
