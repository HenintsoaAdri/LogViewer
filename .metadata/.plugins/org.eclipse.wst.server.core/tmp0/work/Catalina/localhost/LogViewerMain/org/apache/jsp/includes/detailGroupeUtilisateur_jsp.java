...
public final class detailGroupeUtilisateur_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 BaseModelPagination pagination = (BaseModelPagination)request.getAttribute("pagination"); 
	BaseModel item = (BaseModel)request.getAttribute("item");
      ...
      out.write("/Utilisateur/new?item.profil.groupe.id=");
 ...
 if(pagination == null || pagination.getListe() == null || pagination.getListe().isEmpty() ){ 
      out.write("\r\n");
      out.write("      <p class=\"text-danger\">Aucun utilisateur dans ce groupe</p>\r\n");
      out.write("  \t");
