                	...
                	<div class="col-md-12">
                        <div class="white-box">
                            ...
                            <ul class="nav customtab nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class=""><a href="#Groupe" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="fa fa-gears fa-fw"></i></span> <span class="hidden-xs">Groupes gérés (<% out.print(item.getNombreGroupe()); %>)</span></a></li>
                            </ul>
                            <!-- Tab panes -->
